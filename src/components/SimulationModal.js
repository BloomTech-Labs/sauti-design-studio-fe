...
class SimulationModal extends React.Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      this.state.simulate_project !== this.props.simulate_project ||
      prevProps.simulate_project !== this.props.simulate_project
    ) {
      this.setState({
        ...this.state,
        simulate_project: this.props.simulate_project
          ...
          <div className="simulation-container">
            ...
            <div className="simulation-screen-container">
              ...
              <div className="receive-container">
                <p>
                  {this.state.incoming
                    ? this.state.incoming.display.text
                    : "Press Enter in the Text Box to Begin"}
                </p>
                {this.state.incoming
                  ? this.state.incoming.display.options.map((item, index) => {
